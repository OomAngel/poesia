...
[![Tests](https://img.shields.io/badge/tests-423%20passing-brightgreen)](#development)
...
- 423 passing tests; ruff, mypy, bandit, safety enforced in CI
...
Core engine complete; Phases 0–5 + P0–P5 hardening done, **423 tests passing**
